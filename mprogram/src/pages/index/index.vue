    ...
    <div class="weui-cells weui-cells_after-title">
      <div class="weui-cell weui-cell_input">
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="number" pattern="[0-9]*" v-model.lazy="userInfo.blh" placeholder="请输入病历号"/>
        </div>
      </div>
      <div class="weui-cell weui-cell_input">
        <div class="weui-cell__hd"><div class="weui-label">姓名</div></div>
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" v-model.lazy="userInfo.name" placeholder="请输入姓名"/>
        </div>
      </div>
    </div>
    <button type="primary" class="weui-btn" @click="bind">绑定</button>
    <!--<button type="" class="weui-btn">游客登录</button>-->
  </div>
</template>
